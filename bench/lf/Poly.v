...
Check (cons nat 3 (nil nat)). (* .unfold *)
...
Check (cons nat 2 (cons nat 1 (nil nat))). (* .unfold *)
...
Check @prod_curry. (* .unfold *)
Check @prod_uncurry. (* .unfold *)
