...
Check forall n m : nat, n + m = m + n. (* .unfold *)
...
Proof.
  (* WORKED IN CLASS *)
  intros l H.
  Fail apply in_not_nil. (* .fails .unfold .no-goals *)
Abort.
...
Print Assumptions function_equality_ex2. (* .unfold *)
...
Fail Definition is_even_prime n := (* .fails .unfold *)
  if n = 2 then true
  else false.
